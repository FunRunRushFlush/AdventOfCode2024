...
namespace Day01
{
    ...
    text.PadLeft((width + text.Length) / 2).PadRight(width);
            ...
            string filePath = Path.Combine(basePath, "Day01\\Yu-Gi-Oh_Life_Points_Loop.wav");
            string fileFinalPath = Path.Combine(basePath, "Day01\\Yu-Gi-Oh_Life_Points_FinalPart.wav");
