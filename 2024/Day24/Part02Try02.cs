...
public class Part02Try02
{
    ...
    {
        ParseInput(input);
        CalculateMusterLoesung();

        BackUpGates = new List<GateLogic>(Gates);
    ...
    private void CalculateMusterLoesung()
    {
