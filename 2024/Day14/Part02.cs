...
public static class Part02
{
    ...
    private static int SecondLimit = 10000;
    private static int[,] bathroom = new int[bathHeight, bathWidth];

    private static HashSet<(int y, int x)> cluster = new();

    private static int BiggestCluster = 0;
    private static int BiggestClusterTime = 0;
    ...
    private static void LookForRoboCluster(int s)
    {
    ...
    private static void CheckForNeighbors(int y, int x)
    {
    ...
    private static void DrawBathGrid(int s)
    {
        GlobalLog.LogLine($"###################################################");
